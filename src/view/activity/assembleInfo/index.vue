 ...
 * @LastEditTime: 2019-09-28 17:42:36
 -->
<template>
    <div class="registration">
        ...
        <div class="reg-header">
            <div class="reg-header-left">
                <span class="reg-header-btn" @click="jumpLast()">
        ...
        <div style="background:#fff;">
            ...
            <div class="reg-nav">
                ...
                >
                    <el-tab-pane label="拼团信息" name="0"></el-tab-pane>
                </el-tabs>
                <div
                    class="reg-nav-screen"
                    v-show="activeName == 0"
                    @click="aseOrderBtnState = !aseOrderBtnState"
                >
                    筛选&导出
