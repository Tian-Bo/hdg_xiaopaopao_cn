 ...
 * @Author: tianbo
 * @LastEditors: tianbo
 * @Date: 2019-09-30 14:37:11
 * @LastEditTime: 2019-09-30 14:37:11
 -->
<template>
...
export default {
    ...
    data() {
        return {
            ...
            channel_id: this.$route.query.channel_id || '', // 渠道类型
            logo: this.$route.query.logo || "", // 上传logo
            name: this.$route.query.name || "", // 渠道名称
            type: this.$route.query.type || 0, // 渠道类型
            dividend: this.$route.query.dividend || 0, // 分红比列
            countDown: 60, // 倒计时
            userInfo: {
                nickname: this.$route.query.nickname || '',
                head_img: this.$route.query.head_img || '',
                user_id: this.$route.query.principal || '',
            }, // 用头像昵称
    ...
    methods: {
        ...
        onSubmit() {
            ...
            this.$http
                .post(setEditChannel, this.$qs.stringify(params))
                .then(res => {
                    if (res.data.status == 0) {
