 ...
 * @Author: tianbo
 * @LastEditors: tianbo
 * @Date: 2019-09-29 12:01:19
 * @LastEditTime: 2019-10-11 15:12:11
 -->
<template>
    <div>
        <!-- main begin-->
                ...
                <tbody v-for="(item, index) in dataList.list" :key="index">
                    <tr class="reg-list-tbody">
                        ...
                        <td>
                            <router-link
                                tag="a"
                                :to="'/channeRelation?active_id=' + active_id + '&user_id=' + item.id + '&model_id=' + model_id + '&channel_id=' + channel_id + '&tab=' + 1"
                                style="color: #409eff"
                            >详情</router-link>
                        </td>
