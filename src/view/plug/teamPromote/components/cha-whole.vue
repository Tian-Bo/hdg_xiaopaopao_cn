 ...
 * @LastEditTime: 2019-09-27 17:34:35
 -->
<template>
    <div class="tea-value">
        <!-- 筛选详情 -->
        <transition name="fade" mode="out-in">
            <div class="tea-value-details" v-show="show">
                <!--第一行 商户下拉选择器  报名时间 -->
        ...
        <!-- 表格 -->
        <div>
            <chaList :management="management" :loading="loading" />
        </div>
        <!-- 分页 -->
        <el-pagination
...
// 获取api
import { getManageFitter, getChannelOrder } from "@/api/api";
export default {
    props: ['show'],
    ...
    data() {
        return {
            ...
            model_id: this.$route.query.model_id || 0,
            //第一行 商户下拉选择器  报名时间
            user_filter: "", //下拉选中的id
