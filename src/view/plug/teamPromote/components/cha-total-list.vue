 ...
 * @Author: tianbo
 * @LastEditors: tianbo
 * @Date: 2019-09-30 15:21:28
 * @LastEditTime: 2019-10-11 15:05:45
 -->
<template>
    <div>
        <!-- 渠道列表 -->
        <div class="channel-list" v-loading="loading">
            ...
            >
                ...
                <div class="generalize-info flex_1 between-center">
                    <div class="generalize-item" @click="jumpRoute(item, '0')">
                        <div class="font20">{{item.total_number}}</div>
                        <div class="m-t-10">总推广订单</div>
                    </div>
                    <div class="generalize-item" @click="jumpRoute(item, '1')">
                        <div class="font20">{{item.direct_number}}</div>
                        <div class="m-t-10">直接推广（人）</div>
                    </div>
                    <div class="generalize-item" @click="jumpRoute(item, '2')">
        ...
        queryData() {
            ...
            this.$http.get(getChannelList, { params: params }).then(res => {
                ...
                if (res.data.status == 0) {
                    ...
                    this.$emit("getActiveData", res.data.data);
                } else {
