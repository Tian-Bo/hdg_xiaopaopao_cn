        ...
        >
            ...
            <el-table-column width="200">
                <template slot="header">
                    ...
                    >
                        <el-option label="全部下级" value=""></el-option>
                        <el-option label="直接客户" :value="1"></el-option>
                        <el-option label="间接客户" :value="2"></el-option>
                    </el-select>
                </template>
                <template slot-scope="scope">
...
<script>
// 获取api
import { getChannelRecommendInfo } from "@/api/api";
export default {
    data() {
        return {
            loading: true,
            ...
            model_id: this.$route.query.model_id || 0, // 模型id
    ...
    methods: {
        ...
        getCluesterlist() {
            ...
            this.$http.get(getChannelRecommendInfo, { params }).then(res => {
                this.loading = false
